          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                <div className="aspect-[4/3] bg-gradient-to-br from-dark-bg to-navy-deep flex items-center justify-center relative overflow-hidden">
                  <div className="absolute inset-0 opacity-20">
                    <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-medical-blue rounded-full blur-3xl"></div>
                    <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-mint-accent rounded-full blur-3xl"></div>
                  </div>
                  <div className="relative z-10 text-center space-y-4">
                    <div className="w-24 h-24 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mx-auto border border-white/20">
                      <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <p className="text-white/80 text-sm font-medium">3D Brain Simulation</p>
                  </div>
                </div>
              </div>
              {/* Floating Stats */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Watch how NeuroSim transforms surgical planning with real-time 3D simulation and AI analysis
            </p>
          </div>
      ...
      <section className="py-32 px-6 bg-gradient-to-br from-medical-blue via-blue-600 to-mint-accent text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl lg:text-2xl mb-12 text-white/90 leading-relaxed">
            Join leading neurosurgeons who are using NeuroSim to improve patient outcomes and reduce surgical risk.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-6 gap-12 mb-16">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-3xl font-serif font-bold tracking-[-0.02em]">NeuroSim</span>
              </div>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              &copy; 2025 NeuroSim. All rights reserved. Built for HackPrinceton 2025.
            </p>
