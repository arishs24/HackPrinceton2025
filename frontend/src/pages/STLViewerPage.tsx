      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between z-20">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">AI-Powered Brain Structure Analysis</p>
          </div>
        </div>
                ...
                <div className="p-4 border-t border-gray-200 bg-gray-50">
                  ...
                  {feaResults && (
                    <div className="mt-3 p-3 bg-white rounded-lg">
                      <h4 className="text-xs font-semibold text-gray-700 mb-2">FEA Results</h4>
            ...
            <div className="h-full flex items-center justify-center p-12">
              <div className="text-center max-w-md">
                ...
                <p className="text-gray-400 mb-4">
                  The brain scan is being segmented into labeled structures. This may take a few minutes...
                </p>
                {isPolling && (
                  <div className="mt-4 p-3 bg-blue-500/20 rounded-lg">
                    <p className="text-sm text-blue-300">Polling for STL files every 3 seconds...</p>
                  </div>
                )}
              </div>
            </div>
